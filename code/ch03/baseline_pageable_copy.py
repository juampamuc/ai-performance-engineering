"""baseline_pageable_copy.py - Pageable host-transfer baseline.
...
class BaselinePageableCopyBenchmark(VerificationPayloadMixin, BaseBenchmark):
    """Allocates pageable host memory and blocks on every copy.

    Actual NUMA-placement helpers live elsewhere in the chapter. This pair is
    the host-transfer microbenchmark that the historical filename points to.
    """
...
def get_benchmark() -> BaseBenchmark:
    return BaselinePageableCopyBenchmark()
