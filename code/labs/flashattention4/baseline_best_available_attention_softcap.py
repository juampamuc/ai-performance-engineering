"""Explicit softcap-mode baseline target for the best-available FlashAttention-4 path."""
...
class BaselineBestAvailableAttentionSoftcapBenchmark(
...
def get_benchmark() -> BaselineBestAvailableAttentionBenchmark:
    return BaselineBestAvailableAttentionSoftcapBenchmark()
