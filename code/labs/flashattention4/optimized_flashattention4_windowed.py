"""Explicit windowed-mode optimized target for the educational FlashAttention-4 lab."""
...
class OptimizedFlashAttention4WindowedBenchmark(
...
def get_benchmark() -> OptimizedFlashAttention4Benchmark:
    return OptimizedFlashAttention4WindowedBenchmark()
