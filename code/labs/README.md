...
| Path | Description |
| --- | --- |
| `labs/async_input_pipeline`, `labs/block_scaling`, `labs/blackwell_matmul`, `labs/blackwell_gemm_optimizations`, `labs/cudnn_sdpa_bench`, `labs/custom_vs_cublas`, `labs/flashattention4`, `labs/flashattention_gluon`, `labs/flashinfer_attention`, `labs/flexattention`, `labs/memory_bandwidth_patterns`, `labs/nccl_nixl_nvshmem`, `labs/occupancy_tuning`, `labs/parameterized_cuda_graphs`, `labs/persistent_decode`, `labs/recsys_sequence_ranking`, `labs/top_k_kernel`, `labs/training_hotpath` | Benchmark-pair labs with strong kernel/perf narratives and artifact-backed measured deltas, including narrow bandwidth-pattern, attention-backend, communication-stack, and CUDA-graph replay labs. |
| `labs/cache_aware_disagg_inference`, `labs/decode_optimization`, `labs/dynamic_router`, `labs/fullstack_cluster`, `labs/kv_cache_compression`, `labs/kv_optimization`, `labs/moe_cuda`, `labs/moe_cuda_ptx`, `labs/moe_optimization_journey`, `labs/nanochat_fullstack`, `labs/ozaki_scheme`, `labs/real_world_models`, `labs/speculative_decode`, `labs/train_distributed`, `labs/trtllm_phi_3_5_moe` | Benchmark-story labs where the harness pair is part of a broader optimization story across serving, model, distributed-training, or numerical-optimization paths. |
| `labs/cutlass_profiler_kernel_selector`, `labs/moe_decode_blackwell_matrix`, `labs/moe_parallelism`, `labs/python_concurrency`, `labs/tcgen05_cluster_shapes`, `labs/uma_memory`, `labs/vllm-deepseek-tuning` | Larger workflow-oriented, tool-driven, or matrix/playbook labs that need a richer doc model than a simple pair benchmark. |
| `labs/nvfp4_dual_gemm`, `labs/nvfp4_gemm`, `labs/nvfp4_gemv`, `labs/nvfp4_group_gemm` | Low-precision kernel labs where verification discipline matters as much as the timing win. |
