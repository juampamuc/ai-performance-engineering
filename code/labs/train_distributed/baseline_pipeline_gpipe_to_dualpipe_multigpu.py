"""Baseline schedule comparison: GPipe vs DualPipe (GPipe with fragmented micro-batches)."""
...
def main():
    ...
    require_min_gpus(2, script_name="baseline_pipeline_gpipe_to_dualpipe_multigpu.py")
...
def get_benchmark():
    return TorchrunScriptBenchmark(
        ...
        name="baseline_pipeline_gpipe_to_dualpipe_multigpu_2stages",
    )
