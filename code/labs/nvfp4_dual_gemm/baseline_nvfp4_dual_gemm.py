"""Benchmark harness wrapper for NVFP4 dual GEMM baseline submission."""
...
class BaselineNvfp4DualGemmBenchmark(VerificationPayloadMixin, BaseBenchmark):
    """Runs the baseline NVFP4 dual GEMM submission through the benchmark harness."""
    ...
    def benchmark_fn(self) -> None:
        ...
        with self._nvtx_range("baseline_nvfp4_dual_gemm"):
...
def get_benchmark() -> BaseBenchmark:
    return BaselineNvfp4DualGemmBenchmark()
