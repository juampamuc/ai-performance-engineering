...
Keep `proton_matmul_bm64_bn64_bk32_nw2` as a supplementary local-contract schedule benchmark. It is still useful for low-warp occupancy and Proton-vs-Nsight agreement checks, but the canonical speed claims stay on `proton_matmul`, `proton_matmul_bm64_bn256_bk32`, `proton_matmul_bm128_bn128_bk32_nw8`, and `proton_matmul_bm128_bn256_bk64`.
...
- `proton_matmul_bm64_bn64_bk32_nw2` is a supplementary local-contract schedule benchmark; use the larger winning schedules when you want the lab's canonical speed claims.
