"""Optimized GPTQ benchmark for the Chapter 16 PTQ family."""
...
GPTQ_STORY_METADATA = {
    ...
    "optimization_mechanism": "gptq_hessian_scaled_weight_only_quantization_with_int4_weights",
}
...
def get_benchmark() -> BaseBenchmark:
    bench = PTQQuantizationBenchmark(
        scheme="gptq",
        label="optimized_awq_gptq_smoothquant_gptq",
    )
    bench.story_metadata = dict(GPTQ_STORY_METADATA)
